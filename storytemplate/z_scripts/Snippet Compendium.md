...
- File type: Wiki Alpha notes
	...
	- [[Objects]]
	  ![[wikiAlpha.png]]
## barStoryTale
- Used to count distribution of all the **Tales** in **Story**
...
## barWikiTopic
- Used to count distribution of all the **Topics** in **Wiki**
- Can display a bar graph or pie chart
- Steps
...
- Editable parameters
	  ...
	  - `barHeight` - Individual bar height
## barChapter
- Creates chart comparing **Chapter** size in each **Tale**
...
- Editable Parameters
	...
	- `barHeight` - Individual bar height
## barProse
- Creates chart comparing **Total Prose Count** between **Story** and **Wiki**
...
- Editable Parameters
	...
	- `barHeight` - Individual bar height
## barTotal
- Creates chart comparing **Total Word Count** between **Story** and **Wiki**
- Can be a pie or bar chart
- Steps
	- **Scans Two Folders** - Finds all markdown files in both "Story" and "Wiki" folders
	- **Counts Words** - Reads each file and totals words for each section (Story vs Wiki)
