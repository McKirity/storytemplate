...
// Add a title above the table
dv.el("div", `<span style="font-weight:bold !important; text-decoration: underline !important;">Final Draft</span>`, { 
...
function getProgressDisplay(folderName) {
  ...
  const completed = files.filter(f => f["Final Draft"] === true).length;
